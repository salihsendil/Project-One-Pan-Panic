...
public class BurnableBehaviour : MonoBehaviour, IItemBehaviour
{
    ...
    {
        processRule = rule;
        kitchenItem.WorkStage = WorkStage.Burning;
    ...
    public void PauseProcess(KitchenItem kitchenItem)
    {
        ...
        kitchenItem.WorkStage = isPaused ? WorkStage.Idle : WorkStage.Burning;
    }
}
