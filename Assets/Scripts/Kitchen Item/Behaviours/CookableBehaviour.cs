...
public class CookableBehaviour : MonoBehaviour, IItemBehaviour
{
    ...
    public ProcessType GetProcessType() => ProcessType.Cook;
    ...
    {
        processRule = rule;
        kitchenItem.WorkStage = WorkStage.Cooking;
    ...
    public void PauseProcess(KitchenItem kitchenItem)
    {
        ...
        kitchenItem.WorkStage = isPaused ? WorkStage.Idle : WorkStage.Cooking;
    }
}
